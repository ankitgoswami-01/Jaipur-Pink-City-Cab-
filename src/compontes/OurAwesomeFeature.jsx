  ...
  {[
    {
      ...
      icon: "🛡️",
      desc: "Jaipur Pink City Cab ensures a complete safety guarantee with verified drivers, well-maintained vehicles, and secure rides for every passenger."
    },
    {
      title: "Fast Pickup",
      icon: "⚡",
      desc: "Enjoy fast pickup service with Jaipur Pink City Cab. Our nearby drivers ensure quick cab arrival anywhere in Jaipur with minimal waiting time."
    },
    {
      title: "Affordable Rate",
      icon: "💰",
      desc: "Jaipur Pink City Cab offers affordable taxi rates with transparent pricing, no hidden charges, and budget-friendly cab services in Jaipur."
    },
    {
      title: "24/7 Support",
      icon: "🎧",
      desc: "Get 24/7 customer support from Jaipur Pink City Cab. Our team is always available to assist you with bookings, queries, and ride support."
    },
  ].map((item, i) => (
    <div
      key={i}
